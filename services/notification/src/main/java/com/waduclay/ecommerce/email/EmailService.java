...
import com.waduclay.ecommerce.kafka.order.Product;
...
public class EmailService {
    ...
    public void sendPaymentSuccessEmail(
        ...
        try {
            ...
            log.info("Payment confirmation email sent successfully to: {}", destinationEmail);
    ...
    public void sendOrderConfirmation(
        ...
        try {
            ...
            messageHelper.setTo(destinationEmail);
            mailSender.send(mimeMessage);
            log.info("Order confirmation email sent successfully to: {}", destinationEmail);
        }catch (MessagingException e){
            log.warn("Cannot send email to: {}", destinationEmail);
        }
    }
